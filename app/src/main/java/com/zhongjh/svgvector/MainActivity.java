...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 第十三个例子
        findViewById(R.id.btnActivity13).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, Demo13Activity.class));
            }
        });

        // 第十四个例子
        findViewById(R.id.btnActivity14).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, Demo14Activity.class));
            }
        });

        // 第十五个例子
        findViewById(R.id.btnActivity15).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, Demo15Activity.class));
            }
        });

        // 第十六个例子
        findViewById(R.id.btnActivity16).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, Demo16Activity.class));
            }
        });
